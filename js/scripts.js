$ ( document ).ready(function(){
   ...
   let circleD = new ProgressBar.Circle(containerD,{
        ...
        step: function(state, circle) {
            ...
            var value = Math.round(circle.value() * 8001);
            circle.setText(value);
        }
   });
  ...
  setTimeout(function() {
    $('#data-area').parallax({imageSrc: 'img/WallpaperCupCake.jpg'});
...
//Filtro do portfólio
 ...
 $('.filter-btn').on('click', function() {
  ...
  if(type == 'cake-btn') {
    eachBoxes('cake', boxes);
  } else if(type == 'card-btn') {
    eachBoxes('card', boxes);
